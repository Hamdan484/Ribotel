...
import { ArrowRight, ExternalLink, BookOpen, BarChart2, Calendar } from "lucide-react";
              ...
              <div className="p-8 relative flex-1 flex flex-col">
                ...
                <div className="pt-6 space-y-6 flex-1 flex flex-col">
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <h3 className="text-xl font-bold text-[#071333] group-hover:text-blue-600 transition-colors">
                      {project.title}
                    </h3>
                  ...
                  <div className="flex flex-wrap gap-1.5 justify-start">
                    {project.tech.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-1 rounded-md text-[10px] font-semibold bg-blue-50 text-blue-600 border border-blue-100"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#36ADA3] hover:text-[#2A8B83] transition-colors"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-[#071333] transition-colors"
                  >
                    Source{" "}

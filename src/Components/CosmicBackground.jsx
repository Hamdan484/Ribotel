...
export default function CosmicBackground() {
  ...
  return (
    ...
    >
      ...
      {/* Background artwork watermarks */}
      <div
        className="absolute top-1/4 -left-64 h-[600px] w-[600px] rounded-full overflow-hidden pointer-events-none transition-opacity duration-300 select-none"
        style={{ opacity: isDark ? 0.02 : 0.025 }}
      >
        <img
          src="/about_showcase_1.jpg"
          alt=""
      ...
      <div
        className="absolute bottom-1/4 -right-64 h-[650px] w-[650px] rounded-full overflow-hidden pointer-events-none transition-opacity duration-300 select-none"
        style={{ opacity: isDark ? 0.02 : 0.025 }}
      >
        <img
          src="/about_showcase_2.jpg"
          alt=""
          className="h-full w-full object-cover filter grayscale"
        />
      </div>

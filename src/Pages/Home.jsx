  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Stats Section 
          ...
          isDark
            ? "border-white/10 bg-gradient-to-r from-slate-950/90 via-secondary/20 to-slate-950/90"
            : "border-slate-200/70 bg-gradient-to-r from-white/90 via-secondary/5 to-other/5"
        }`}
      >
              ...
              >
                <div
                  className={`mb-2 font-display text-4xl font-bold md:text-5xl ${
                    isDark ? "text-other" : "text-primary"
                  }`}
                >
                  {stat.value}
                </div>
